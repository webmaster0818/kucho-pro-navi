...
export const metadata: Metadata = {
  title: "利用規約",
  description: "空調プロナビの利用規約です。サービス概要、禁止事項、免責事項などについて定めています。",
};
    ...
    <>
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-8 space-y-8 text-sm leading-relaxed text-gray-700">
          ...
          <section>
            <h2 className="text-base font-bold text-gray-900 mb-3 pb-2 border-b-2 border-[#1E40AF]">第1条（サービスの概要）</h2>
            <p>
              空調プロナビ（以下「当サイト」）は、業務用エアコンの設置・交換・修理業者の比較・情報提供を目的としたウェブサイトです。当サイトは、空調工事業者に関する情報の収集・整理・提供を行うものであり、実際の工事や契約は各業者との間で行われます。当サイトは業者と利用者との契約関係に一切関与しません。
            </p>
          </section>

          <section>
            <h2 className="text-base font-bold text-gray-900 mb-3 pb-2 border-b-2 border-[#1E40AF]">第2条（禁止事項）</h2>
          ...
          <section>
            <h2 className="text-base font-bold text-gray-900 mb-3 pb-2 border-b-2 border-[#1E40AF]">第3条（免責事項）</h2>
            <p className="mb-2">
          ...
          <section>
            <h2 className="text-base font-bold text-gray-900 mb-3 pb-2 border-b-2 border-[#1E40AF]">第4条（アフィリエイト広告について）</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-gray-900 mb-3 pb-2 border-b-2 border-[#1E40AF]">第5条（知的財産権）</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-gray-900 mb-3 pb-2 border-b-2 border-[#1E40AF]">第6条（リンクについて）</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-gray-900 mb-3 pb-2 border-b-2 border-[#1E40AF]">第7条（規約の変更）</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-gray-900 mb-3 pb-2 border-b-2 border-[#1E40AF]">第8条（準拠法・管轄裁判所）</h2>
            <p>
