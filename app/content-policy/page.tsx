...
export const metadata: Metadata = {
  title: "記事の制作ポリシー",
  description: "空調プロナビの記事制作ポリシーです。編集方針・情報の正確性への取り組み・広告との関係について説明しています。",
};
  ...
  return (
    <>
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">記事の制作ポリシー</h1>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-8 space-y-8 text-sm leading-relaxed text-gray-700">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-5">
            <p className="text-blue-900 font-medium">
              空調プロナビは、業務用エアコンの導入を検討する事業者の方々が最適な業者を選べるよう、独自の調査・比較に基づいた公正な情報提供を行うことをお約束します。
            </p>
          </div>

          <section>
            <h2 className="text-base font-bold text-gray-900 mb-3 pb-2 border-b-2 border-[#1E40AF]">編集方針</h2>
            <p className="mb-2">
              当サイトのコンテンツは、業務用空調・設備工事に関する専門知識を持つ編集者・ライターが、独自の調査・比較・取材に基づいて制作しています。主な制作基準は以下のとおりです。
            </p>
            <ul className="list-disc list-inside space-y-1 ml-2">
              <li>複数の業者・情報源を比較し、読者に有益な情報を提供する</li>
              <li>主観的な意見と客観的な事実を明確に区別して記載する</li>
              <li>業種・規模・用途に応じた具体的な情報を優先する</li>
              <li>専門用語には適切な解説を付記する</li>
            </ul>
          </section>

          <section>
            <h2 className="text-base font-bold text-gray-900 mb-3 pb-2 border-b-2 border-[#1E40AF]">情報の正確性への取り組み</h2>
            <p className="mb-2">
          ...
          <section>
            <h2 className="text-base font-bold text-gray-900 mb-3 pb-2 border-b-2 border-[#1E40AF]">広告・アフィリエイトとの関係</h2>
            <p className="mb-2">
              当サイトはアフィリエイト広告を含みますが、広告収益の有無はランキングや評価に一切影響しません。
            </p>
            <ul className="list-disc list-inside space-y-1 ml-2">
              <li>ランキングは独自の評価基準（価格・施工品質・対応速度・保証内容・実績等）に基づき決定しています</li>
          ...
          <section>
            <h2 className="text-base font-bold text-gray-900 mb-3 pb-2 border-b-2 border-[#1E40AF]">更新頻度</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-gray-900 mb-3 pb-2 border-b-2 border-[#1E40AF]">引用・参考元の明示</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-gray-900 mb-3 pb-2 border-b-2 border-[#1E40AF]">読者からのフィードバック対応</h2>
            <p>
