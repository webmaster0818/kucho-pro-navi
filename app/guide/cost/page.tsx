...
const subsidyInfo = [
  {
    name: "省エネ補助金（環境省）",
    desc: "省エネ性能の高い業務用空調設備への更新に最大1/3〜1/2の補助",
    amount: "50万〜500万円",
  },
  {
    name: "ものづくり補助金",
    desc: "設備投資による生産性向上を支援。工場の空調改善に活用可能",
    amount: "100万〜5,000万円",
  },
  {
    name: "東京都・各自治体補助金",
    desc: "地域独自の省エネ設備補助金。自治体により条件・金額が異なる",
    amount: "10万〜100万円",
  },
  {
    name: "中小企業向け設備投資減税",
    desc: "中小企業等経営強化法に基づく即時償却・税額控除",
    amount: "取得価格の10%税額控除",
  },
];
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        ...
        <section className="mb-10">
          ...
          <p className="text-xs text-gray-500 mt-3">
            ※補助金の条件・金額は年度ごとに変更されます。最新情報は各省庁・自治体公式サイトでご確認ください。
          </p>
        </section>
