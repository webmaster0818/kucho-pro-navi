...
export const metadata: Metadata = {
  ...
  description:
    "AIマッチングの相見積もりサービス「ミツモア」（運営：株式会社ミツモア）の口コミ・評判をまとめました。業務用エアコンの一括見積もりでの使い方、料金や手数料の仕組み、メリット・デメリット、向いている事業者まで中立的に解説します。",
      ...
      <article className="bg-white">
        ...
        <div className="max-w-3xl mx-auto px-5 pt-8">
          <p className="text-[1.05rem] leading-8 text-slate-700">
            ...
            （運営：株式会社ミツモア）です。この記事では、業務用エアコンの一括見積もりという視点で、実際に公開されている利用者の口コミ、料金や手数料の仕組み、メリット・デメリットを、良い点・気になる点の両面から中立的にまとめました。
          </p>
