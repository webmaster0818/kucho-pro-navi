...
export const metadata: Metadata = {
  title:
    "空調センターの口コミ・評判は？業務用エアコンの料金・対応エリアを徹底調査【2026年7月】｜空調プロナビ",
  description:
    "業務用エアコンの販売専門店「空調センター」の口コミ・評判をまとめました。最大83%OFFの価格や全国送料無料、即日緊急対応などの特徴に加え、設置工事は非対応という点も含めて中立的に解説。利用者の声と選び方の注意点を2026年7月時点の情報で紹介します。",
